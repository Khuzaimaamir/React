...
export default function About(props) {
    ...
    // })
    const myStyle = {
        backgroundColor: props.mode === 'dark' ? '#00071a' : 'white',
        color: props.mode === 'dark' ? 'white' : '#00071a',
    };
    ...
    return (
        <div style={myStyle}>
            <div className="container my-3" style={myStyle} ><div class="accordion" id="accordionExample">
                <h1>About us</h1>
